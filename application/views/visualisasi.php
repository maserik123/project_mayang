...
<script>
    var chart = AmCharts.makeChart("chartdiv_1_bagian_3", {
        ...
        "dataProvider": [{
            ...
            "kepemimpinan": <?php echo !empty($kepemimpinanTK[0]->total_kepemimpinan_tk) ? $kepemimpinanTK[0]->total_kepemimpinan_tk : 0; ?>,
            "sopan_santun": <?php echo !empty($sopanSantunTK[0]->total_sopansantun_tk) ? $sopanSantunTK[0]->total_sopansantun_tk : 0; ?>,
            "kejujuran": <?php echo !empty($kejujuranTK[0]->total_kejujuran_tk) ? $kejujuranTK[0]->total_kejujuran_tk : 0; ?>,
        }, {
            "year": "SD",
